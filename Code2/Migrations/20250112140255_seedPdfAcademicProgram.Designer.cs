...
namespace Code2.Migrations
{
    ...
    [Migration("20250112140255_seedPdfAcademicProgram")]
    partial class seedPdfAcademicProgram
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Code2.Models.Pdf", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UploadedAt = new DateTime(2025, 1, 12, 14, 2, 54, 336, DateTimeKind.Utc).AddTicks(2036),
                            UploadedBy = "John Doe",
                            UserId = 1,
                            Views = 1000
                        },
                        new
                        {
                            ...
                            UploadedAt = new DateTime(2025, 1, 12, 14, 2, 54, 336, DateTimeKind.Utc).AddTicks(2441),
                            UploadedBy = "John Doe",
                            UserId = 1,
                            Views = 800
                        },
                        new
                        {
                            ...
                            UploadedAt = new DateTime(2025, 1, 12, 14, 2, 54, 336, DateTimeKind.Utc).AddTicks(2443),
                            UploadedBy = "John Doe",
                            UserId = 1,
                            Views = 1200
                        },
                        new
                        {
                            ...
                            UploadedAt = new DateTime(2025, 1, 12, 14, 2, 54, 336, DateTimeKind.Utc).AddTicks(2445),
                            UploadedBy = "John Doe",
                            UserId = 1,
                            Views = 1500
                        },
                        new
                        {
                            ...
                            UploadedAt = new DateTime(2025, 1, 12, 14, 2, 54, 336, DateTimeKind.Utc).AddTicks(2448),
                            UploadedBy = "John Doe",
                            UserId = 1,
                            Views = 950
                        });
            ...
            modelBuilder.Entity("Code2.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedDate = new DateTime(2025, 1, 12, 14, 2, 54, 335, DateTimeKind.Utc).AddTicks(2357),
                        ...
                        {
                            UserId = 2,
                            CreatedDate = new DateTime(2025, 1, 12, 14, 2, 54, 335, DateTimeKind.Utc).AddTicks(2557),
                        ...
                        {
                            UserId = 3,
                            CreatedDate = new DateTime(2025, 1, 12, 14, 2, 54, 335, DateTimeKind.Utc).AddTicks(2585),
                        ...
                        {
                            UserId = 4,
                            CreatedDate = new DateTime(2025, 1, 12, 14, 2, 54, 335, DateTimeKind.Utc).AddTicks(2588),
